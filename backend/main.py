...
# # Suppress TensorFlow warning about compile metrics
# absl.logging.set_verbosity(absl.logging.ERROR)

# app = FastAPI()

# # Expose app as `sio_app` (optional, for uvicorn main:sio_app compatibility)
# sio_app = app
...
# # Load the model (no need to compile for inference)
