...
//   useEffect(() => {
//   fetch('${https://plant-project-stuff-trial-forked-co.vercel.app/}/history')
//     .then(res => res.json())
//     .then(data => {
...
//     window.open(`${https://plant-project-stuff-trial-forked-co.vercel.app/}/download/pdf/${diagnosis.reportFilename}`, "_blank")};
//   };

//   const handleDownloadPDF = (diagnosis) => {
//     const link = document.createElement('a');
//     link.href = `http://localhost:8000/download/pdf/${diagnosis.reportFilename}`;
...
//                       <Button onClick={() => window.open(`http://localhost:8000${diagnosis.image_url}`, "_blank")}>
...
//         {/* Table of results or empty state */}
//         {/* See previous messages for full table rendering or fallback message */}
//       </div>
//     </div>
//   );
// };
...
const BACKEND_URL = "https://plant-project-stuff-trial-forked-co.vercel.app";
